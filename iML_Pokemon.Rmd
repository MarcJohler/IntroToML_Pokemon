...
learner_tunedglmnet <- AutoTuner$new(learner_glmnet,resample_inner,measures,tune_ps, terminator, tuner)
...
learner_tunednb <- AutoTuner$new(learner_nb,resample_inner,measures,tune_ps,terminator,tuner)
...
learner_tunedkknn <- AutoTuner$new(learner_kknn,resample_inner,measures,tune_ps,terminator,tuner)
